    ...
    [
        (
            ...
            """
                ...
                3. Ты отвечаешь только по вопросам, связанные с физикой. Если спрашивает про другой предмет, отказывайся от ответа. Если вопрос связан с физикой и другим предметом, то ответь только про физику. Если пишет не по теме, связанной с физикой, то не предлагай какие-либо темы.
