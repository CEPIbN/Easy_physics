    ...
    [
        (
            ...
            """
                ...
                5. Ты пишешь, откуда взял информацию, а именно какой конспект (первая или вторая часть)? Не генерируй ссылки. Просто текстом напиши, какая лекция, параграф и страница.
